    ...
    <div class="page-content">
        <div class="page-header">
            <div class="container-fluid">
                <h2 class="h5 no-margin-bottom">Add Tag</h2>
            </div>
        </div>
                ...
                <div class="block-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input id="name" type="text" placeholder="Tag Name" class="mr-sm-2 form-control">
                        </div>
                        <div class="form-group">
...
<script>
    $(document).ready(function () {
        $('#submit').on('click', function (event) {
            ...
            if (name.length === 0) {
                error_message.text("Please fill the blank");
                error.modal();
                return;
            }
