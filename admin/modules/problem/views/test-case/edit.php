<input type="hidden" id="test_case_id" value="<?= /** @var $test_case \common\models\TestCase */ $test_case->id ?>">
    ...
    <div class="page-content">
        <div class="page-header">
            <div class="container-fluid">
                <h2 class="h5 no-margin-bottom">Update Test Case <code># <?=  $test_case->id ?></code></h2>
            </div>
        </div>
