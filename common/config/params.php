...
return [
    ...
    'staticFile' => [
        ...
        'SemanticUI' => [
            'css' => 'https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.2.13/semantic.min.css',
            'js' => 'https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.2.13/semantic.min.js'
        ],
        'CodeMirror' => [
            'css' => 'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.31.0/codemirror.min.css',
            'theme' => 'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.31.0/theme/monokai.min.css',
